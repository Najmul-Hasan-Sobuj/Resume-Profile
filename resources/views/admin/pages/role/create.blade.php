                ...
                <div class="bg-gray-100 p-4 rounded-lg">
                    <div class="flex items-center mb-5">
                        ...
                        <label for="selectAllGroupPermissions_{{ $loop->iteration }}"
                            ...
                            <h2 class="text-lg font-semibold mb-2"> Select All {{ $group->group_name }}</h2>
                        </label>
                    </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                selectAllPermissions.addEventListener('change', function() {
                    ...
                    // Update state of selectAllGroupPermissions_ checkboxes
                    selectAllGroupPermissions.forEach(function(selectAllCheckbox) {
                        selectAllCheckbox.checked = selectAllPermissions.checked;
                    });
                });
            });
        </script>
