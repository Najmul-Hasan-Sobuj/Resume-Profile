                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <x-text-input id="degree_one" class="block mt-1 w-full" type="text" name="degree_one"
                            :value="old('degree_one', $resumeProfile->degree_one)" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="institution_one" class="block mt-1 w-full" type="text"
                            name="institution_one" :value="old('institution_one', $resumeProfile->institution_one)" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="start_year_one" class="block mt-1 w-full" type="number" name="start_year_one"
                            :value="old('start_year_one', $resumeProfile->start_year_one)" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="end_year_one" class="block mt-1 w-full" type="number" name="end_year_one"
                            :value="old('end_year_one', $resumeProfile->end_year_one)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="degree_two" class="block mt-1 w-full" type="text" name="degree_two"
                            :value="old('degree_two', $resumeProfile->degree_two)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="institution_two" class="block mt-1 w-full" type="text"
                            name="institution_two" :value="old('institution_two', $resumeProfile->institution_two)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="start_year_two" class="block mt-1 w-full" type="number"
                            name="start_year_two" :value="old('start_year_two', $resumeProfile->start_year_two)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="end_year_two" class="block mt-1 w-full" type="number" name="end_year_two"
                            :value="old('end_year_two', $resumeProfile->end_year_two)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="degree_three" class="block mt-1 w-full" type="text" name="degree_three"
                            :value="old('degree_three', $resumeProfile->degree_three)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="institution_three" class="block mt-1 w-full" type="text"
                            name="institution_three" :value="old('institution_three', $resumeProfile->institution_three)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="start_year_three" class="block mt-1 w-full" type="number"
                            name="start_year_three" :value="old('start_year_three', $resumeProfile->start_year_three)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="end_year_three" class="block mt-1 w-full" type="number"
                            name="end_year_three" :value="old('end_year_three', $resumeProfile->end_year_three)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="work_position_one" class="block mt-1 w-full" type="text"
                            name="work_position_one" :value="old('work_position_one', $resumeProfile->work_position_one)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="company_one" class="block mt-1 w-full" type="text" name="company_one"
                            :value="old('company_one', $resumeProfile->company_one)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="work_start_year_one" class="block mt-1 w-full" type="number"
                            name="work_start_year_one" :value="old('work_start_year_one', $resumeProfile->work_start_year_one)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="work_end_year_one" class="block mt-1 w-full" type="number"
                            name="work_end_year_one" :value="old('work_end_year_one', $resumeProfile->work_end_year_one)" />
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea id="work_description_one"
                            class="form-input w-full text-gray-800 rounded-md bg-gray-50 border border-gray-300 focus:border-blue-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-300 p-2 transition duration-200 ease-in-out shadow-sm hover:border-blue-400"
                            name="work_description_one">{{ old('work_description_one', $resumeProfile->work_description_one) }}</textarea>
                    ...
                    <div>
                        ...
                        <x-text-input id="work_position_two" class="block mt-1 w-full" type="text"
                            name="work_position_two" :value="old('work_position_two', $resumeProfile->work_position_two)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="company_two" class="block mt-1 w-full" type="text" name="company_two"
                            :value="old('company_two', $resumeProfile->company_two)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="work_start_year_two" class="block mt-1 w-full" type="number"
                            name="work_start_year_two" :value="old('work_start_year_two', $resumeProfile->work_start_year_two)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="work_end_year_two" class="block mt-1 w-full" type="number"
                            name="work_end_year_two" :value="old('work_end_year_two', $resumeProfile->work_end_year_two)" />
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea id="work_description_two"
                            class="form-input w-full text-gray-800 rounded-md bg-gray-50 border border-gray-300 focus:border-blue-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-300 p-2 transition duration-200 ease-in-out shadow-sm hover:border-blue-400"
                            name="work_description_two">{{ old('work_description_two', $resumeProfile->work_description_two) }}</textarea>
                    ...
                    <div>
                        ...
                        <x-text-input id="work_position_three" class="block mt-1 w-full" type="text"
                            name="work_position_three" :value="old('work_position_three', $resumeProfile->work_position_three)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="company_three" class="block mt-1 w-full" type="text"
                            name="company_three" :value="old('company_three', $resumeProfile->company_three)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="work_start_year_three" class="block mt-1 w-full" type="number"
                            name="work_start_year_three" :value="old('work_start_year_three', $resumeProfile->work_start_year_three)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="work_end_year_three" class="block mt-1 w-full" type="number"
                            name="work_end_year_three" :value="old('work_end_year_three', $resumeProfile->work_end_year_three)" />
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea id="work_description_three"
                            class="form-input w-full text-gray-800 rounded-md bg-gray-50 border border-gray-300 focus:border-blue-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-300 p-2 transition duration-200 ease-in-out shadow-sm hover:border-blue-400"
                            name="work_description_three">{{ old('work_description_three', $resumeProfile->work_description_three) }}</textarea>
                    ...
                    <div>
                        ...
                        <x-text-input id="project_title_one" class="block mt-1 w-full" type="text"
                            name="project_title_one" :value="old('project_title_one', $resumeProfile->project_title_one)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="project_technologies_one" class="block mt-1 w-full" type="text"
                            name="project_technologies_one" :value="old('project_technologies_one', $resumeProfile->project_technologies_one)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="project_url_one" class="block mt-1 w-full" type="url"
                            name="project_url_one" :value="old('project_url_one', $resumeProfile->project_url_one)" />
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea id="project_description_one"
                            class="form-input w-full text-gray-800 rounded-md bg-gray-50 border border-gray-300 focus:border-blue-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-300 p-2 transition duration-200 ease-in-out shadow-sm hover:border-blue-400"
                            name="project_description_one">{{ old('project_description_one', $resumeProfile->project_description_one) }}</textarea>
                    ...
                    <div>
                        ...
                        <x-text-input id="project_title_two" class="block mt-1 w-full" type="text"
                            name="project_title_two" :value="old('project_title_two', $resumeProfile->project_title_two)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="project_technologies_two" class="block mt-1 w-full" type="text"
                            name="project_technologies_two" :value="old('project_technologies_two', $resumeProfile->project_technologies_two)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="project_url_two" class="block mt-1 w-full" type="url"
                            name="project_url_two" :value="old('project_url_two', $resumeProfile->project_url_two)" />
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea id="project_description_two"
                            class="form-input w-full text-gray-800 rounded-md bg-gray-50 border border-gray-300 focus:border-blue-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-300 p-2 transition duration-200 ease-in-out shadow-sm hover:border-blue-400"
                            name="project_description_two">{{ old('project_description_two', $resumeProfile->project_description_two) }}</textarea>
                    ...
                    <div>
                        ...
                        <x-text-input id="project_title_three" class="block mt-1 w-full" type="text"
                            name="project_title_three" :value="old('project_title_three', $resumeProfile->project_title_three)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="project_technologies_three" class="block mt-1 w-full" type="text"
                            name="project_technologies_three" :value="old('project_technologies_three', $resumeProfile->project_technologies_three)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="project_url_three" class="block mt-1 w-full" type="url"
                            name="project_url_three" :value="old('project_url_three', $resumeProfile->project_url_three)" />
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea id="project_description_three"
                            class="form-input w-full text-gray-800 rounded-md bg-gray-50 border border-gray-300 focus:border-blue-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-300 p-2 transition duration-200 ease-in-out shadow-sm hover:border-blue-400"
                            name="project_description_three">{{ old('project_description_three', $resumeProfile->project_description_three) }}</textarea>
                    ...
                    <div>
                        ...
                        <x-text-input id="project_title_four" class="block mt-1 w-full" type="text"
                            name="project_title_four" :value="old('project_title_four', $resumeProfile->project_title_four)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="project_technologies_four" class="block mt-1 w-full" type="text"
                            name="project_technologies_four" :value="old('project_technologies_four', $resumeProfile->project_technologies_four)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="project_url_four" class="block mt-1 w-full" type="url"
                            name="project_url_four" :value="old('project_url_four', $resumeProfile->project_url_four)" />
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea id="project_description_four"
                            class="form-input w-full text-gray-800 rounded-md bg-gray-50 border border-gray-300 focus:border-blue-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-300 p-2 transition duration-200 ease-in-out shadow-sm hover:border-blue-400"
                            name="project_description_four">{{ old('project_description_four', $resumeProfile->project_description_four) }}</textarea>
                    ...
                    <div>
                        ...
                        <x-text-input id="project_title_five" class="block mt-1 w-full" type="text"
                            name="project_title_five" :value="old('project_title_five', $resumeProfile->project_title_five)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="project_technologies_five" class="block mt-1 w-full" type="text"
                            name="project_technologies_five" :value="old('project_technologies_five', $resumeProfile->project_technologies_five)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="project_url_five" class="block mt-1 w-full" type="url"
                            name="project_url_five" :value="old('project_url_five', $resumeProfile->project_url_five)" />
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea id="project_description_five"
                            class="form-input w-full text-gray-800 rounded-md bg-gray-50 border border-gray-300 focus:border-blue-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-300 p-2 transition duration-200 ease-in-out shadow-sm hover:border-blue-400"
                            name="project_description_five">{{ old('project_description_five', $resumeProfile->project_description_five) }}</textarea>
                    ...
                    <div>
                        ...
                        <x-text-input id="social_platform_one" class="block mt-1 w-full" type="text"
                            name="social_platform_one" :value="old('social_platform_one', $resumeProfile->social_platform_one)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="social_profile_type_one" class="block mt-1 w-full" type="text"
                            name="social_profile_type_one" :value="old('social_profile_type_one', $resumeProfile->social_profile_type_one)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="social_url_one" class="block mt-1 w-full" type="url"
                            name="social_url_one" :value="old('social_url_one', $resumeProfile->social_url_one)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="social_platform_two" class="block mt-1 w-full" type="text"
                            name="social_platform_two" :value="old('social_platform_two', $resumeProfile->social_platform_two)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="social_profile_type_two" class="block mt-1 w-full" type="text"
                            name="social_profile_type_two" :value="old('social_profile_type_two', $resumeProfile->social_profile_type_two)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="social_url_two" class="block mt-1 w-full" type="url"
                            name="social_url_two" :value="old('social_url_two', $resumeProfile->social_url_two)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="social_platform_three" class="block mt-1 w-full" type="text"
                            name="social_platform_three" :value="old('social_platform_three', $resumeProfile->social_platform_three)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="social_profile_type_three" class="block mt-1 w-full" type="text"
                            name="social_profile_type_three" :value="old('social_profile_type_three', $resumeProfile->social_profile_type_three)" />
                    ...
                    <div>
                        ...
                        <x-text-input id="social_url_three" class="block mt-1 w-full" type="url"
                            name="social_url_three" :value="old('social_url_three', $resumeProfile->social_url_three)" />
                    ...
                    <div>
                        ...
                        <select name="is_approved" id="is_approved"
                            ...
                            <option value="1"
                                {{ old('is_approved', $resumeProfile->is_approved) == '1' ? 'selected' : '' }}>Active
                            </option>
                            <option value="0"
                                {{ old('is_approved', $resumeProfile->is_approved) == '0' ? 'selected' : '' }}>In
                                Active
                            </option>
                        </select>
                        @error('is_approved')
