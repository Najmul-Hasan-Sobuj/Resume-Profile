<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('admin.privacy-policy.index')" :active="request()->routeIs('admin.privacy-policy.*')">
                        {{ __('Privacy Policy') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('admin.terms-and-condition.index')" :active="request()->routeIs('admin.terms-and-condition.*')">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('admin.author.index')" :active="request()->routeIs('admin.author.*')">
                {{ __('Author') }}
            </x-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('admin.privacy-policy.index')" :active="request()->routeIs('admin.privacy-policy.*')">
                {{ __('Privacy Policy') }}
            </x-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('admin.terms-and-condition.index')" :active="request()->routeIs('admin.terms-and-condition.*')">
                {{ __('Terms and Condition') }}
            </x-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
